 ...
 * <p>
 * 映射规则：
 * 400: INVALID_ARGUMENT, INVALID_APPROVAL_DECISION, CHECKPOINT_NOT_RESUMABLE, APPROVAL_REQUIRED
 ...
 * 404: AGENT_NOT_FOUND, SUPERVISOR_NOT_FOUND, USER_NOT_FOUND, CHECKPOINT_NOT_FOUND, APPROVAL_NOT_FOUND
 * 409: USER_ALREADY_EXISTS, ROLE_ALREADY_EXISTS, APPROVAL_ALREADY_DECIDED, CHECKPOINT_CONFLICT, RUN_ALREADY_RESUMING
    ...
    private HttpStatus mapErrorCodeToHttpStatus(AgentErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case AGENT_NOT_FOUND, SUPERVISOR_NOT_FOUND, USER_NOT_FOUND,
                 CHECKPOINT_NOT_FOUND, APPROVAL_NOT_FOUND -> HttpStatus.NOT_FOUND;

            // 409 Conflict
            case USER_ALREADY_EXISTS, ROLE_ALREADY_EXISTS,
                 APPROVAL_ALREADY_DECIDED, CHECKPOINT_CONFLICT, RUN_ALREADY_RESUMING -> HttpStatus.CONFLICT;
            ...
            case MAX_ITERATIONS_REACHED, TOOL_EXECUTION_FAILED,
                 RESUME_FAILED, INTERNAL_ERROR -> HttpStatus.INTERNAL_SERVER_ERROR;
